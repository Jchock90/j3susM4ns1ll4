  ...
  return (
    <footer className="bg-darkGray bg-opacity-80 p-4 mt-8">
      <div className="container mx-auto flex justify-between items-center text-lightGray">
        ...
        {/* Derechos de autor en el centro con link */}
        <div className="text-center text-gray-300">
          &copy; 2024 <a className='hover:text-violet' href="https://github.com/Jchock90" target="_blank" rel="noopener noreferrer">Jesús Mansilla</a>.
        </div>
